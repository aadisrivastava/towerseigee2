...
function setup(){
    ...
    box18 = new Box(755,150,25,35);
    box19 = new Box(780,150,25,35);

    box20 = new Box(740,105,25,35);
    box21 = new Box(760,105,25,35);

    box22 = new Box(750,95,25,35);
...
function draw(){
  ...
  image(polygon_img ,polygon.position.x,polygon.position.y,40,40);
    ...
    slingshot.display();
    text("Drag the hexagonal ball towards the bricks to make them fall",300,20);
 text("Press the spacebar to get a rechance",700,350)
